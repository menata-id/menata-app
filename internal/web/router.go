...
func Routes(d Deps) http.Handler {
	...
	r.Group(func(pr chi.Router) {
		...
		pr.Get("/dashboard", showDashboard(d.Store, d.AppName))
		pr.Get("/my-tasks", showMyTasks(d.Store, d.AppName, d.Cfg))
		pr.Get("/board-settings", showBoardSettings(d.Store, d.AppName))
		pr.Get("/activity", showActivity(d.Store, d.AppName))
		pr.Get("/team-capacity", showTeamCapacity(d.Store, d.AppName))
