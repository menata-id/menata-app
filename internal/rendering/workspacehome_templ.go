...
//
// This page's own closing row (now "Settings", 2026-09-25) keeps its own inline
// `workspaceRole != "member"` check, which is the half of the 2026-09-19 code-review finding that
// can still leak.
